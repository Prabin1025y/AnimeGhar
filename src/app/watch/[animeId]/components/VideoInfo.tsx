...
const SeasonCard: React.FC<{ poster: string; name: string; isCurrent:boolean }> = ({ poster, name, isCurrent }) => (
  ...
  const VideoInfo: React.FC<VideoInfoProps> = ({
    ...
    return (
      animeDetail === null ? (
        ...
        <div className="bg-gray-900 rounded-lg p-6 grid gap-6 grid-cols-4 grid-rows-[auto auto] items-start">
          {/* Poster */}
          ...
          <div className="row-start-2 col-start-1 flex gap-3 mt-2">
  ...
  const VideoInfoSkeleton: React.FC = () => (
    <div className="bg-gray-900 rounded-lg p-6 grid gap-6 grid-cols-4 grid-rows-[auto auto] items-start animate-pulse">
      {/* Poster Skeleton */}
